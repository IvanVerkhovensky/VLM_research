...
Success-rate eval в симуляции LIBERO или аналогичный и также controlled perturbations, чтобы связать action drift с реальным успехом или провалом задач.
Лёгкий fine tune например LoRA baseline против +регуляризаторы из гипотезы и сравнение до и после по тем же аудитам и по success rate.
