# VLA audit: SmolVLA × Smol-LIBERO (MacBook)

Я сделал небольшой воспроизводимый аудит публичной VLA политики для манипуляции - насколько она  
 зависит от текста инструкции и насколько чувствительна к небольшим визуальным сдвигам .
